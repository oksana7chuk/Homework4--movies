...
const AsyncMovieDetails = lazy(() =>
  import(
    "../src/pages/MovieDetailsPage" /*webpackChunkName: "movie-detailes-page"*/
  )
);
const AsyncMovies = lazy(() =>
  import("../src/pages/MoviesPage" /*webpackChunkName: "movies-page"*/)
);
  ...
  <div>
    ...
    <Suspense fallback={<h1>Loading...</h1>}>
      <Switch>
        ...
        <Route path="/movies/:movieId" exact component={AsyncMovieDetails} />
